...
""",
    'data': [
        ...
        'wizard_test/base_module_update_views.xml',
        'wizard_test/base_language_install_views.xml',
        'wizard_test/base_import_language_views.xml',
        'wizard_test/base_module_upgrade_views.xml',
        'wizard_test/base_module_uninstall_views.xml',
        'wizard_test/base_export_language_views.xml',
        'wizard_test/base_partner_merge_views.xml',
