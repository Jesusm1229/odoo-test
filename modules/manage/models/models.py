...
class History(models.Model):
    ...
    #used technologies
    technology_ids = fields.Many2many('manage.technology', compute = '_get_technologies', store=True, string="Technologies")
...
class Task(models.Model):
    ...
    sprint_id = fields.Many2one('manage.sprint', ondelete='set null', compute='_get_sprint', store=True, string="Sprint")
