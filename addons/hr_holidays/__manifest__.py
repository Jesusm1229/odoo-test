...
""",
    ...
    'data': [
        ...
        'wizard_test/hr_holidays_cancel_leave_views.xml',
        'wizard_test/hr_holidays_summary_employees_views.xml',
        'wizard_test/hr_leave_generate_multi_wizard_views.xml',
        'wizard_test/hr_leave_allocation_generate_multi_wizard_views.xml',
