...

{
    ...
    'data': [
        ...
        'wizard_test/stock_change_product_qty_views.xml',
        'wizard_test/stock_picking_return_views.xml',
        'wizard_test/stock_inventory_conflict.xml',
        'wizard_test/stock_backorder_confirmation_views.xml',
        ...
        'wizard_test/stock_track_confirmation_views.xml',
        'wizard_test/stock_orderpoint_snooze_views.xml',
        'wizard_test/stock_package_destination_views.xml',
        'wizard_test/stock_inventory_adjustment_name.xml',
        'wizard_test/stock_inventory_warning.xml',
        'wizard_test/stock_label_type.xml',
        'wizard_test/stock_lot_label_layout.xml',
        'wizard_test/stock_quant_relocate.xml',
