...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'data': [
        ...
        'wizard_test/mail_activity_schedule_views.xml',
        'wizard_test/mail_blacklist_remove_views.xml',
        'wizard_test/mail_compose_message_views.xml',
        'wizard_test/mail_resend_message_views.xml',
        'wizard_test/mail_resend_partner_views.xml',
        'wizard_test/mail_template_preview_views.xml',
        'wizard_test/mail_wizard_invite_views.xml',
        'wizard_test/mail_template_reset_views.xml',
