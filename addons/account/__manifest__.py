...
You could use this simplified accounting in case you work with an (external) account to keep your books, and you still want to keep track of payments. This module also offers you an easy method of registering payments, without having to encode complete abstracts of account.
    ...
    'data': [
        ...
        'wizard_test/account_automatic_entry_wizard_views.xml',
        'wizard_test/account_autopost_bills_wizard.xml',
        'wizard_test/account_unreconcile_view.xml',
        'wizard_test/account_move_reversal_view.xml',
        'wizard_test/account_resequence_views.xml',
        'wizard_test/account_payment_register_views.xml',
        'views/account_move_views.xml',
        'wizard_test/setup_wizards_view.xml',
        ...
        'wizard_test/account_validate_move_view.xml',
        ...
        'wizard_test/account_move_send_wizard.xml',
        'wizard_test/account_move_send_batch_wizard.xml',
        'report/account_hash_integrity_templates.xml',
        'views/res_currency.xml',
        'views/account_menuitem.xml',
        'wizard_test/account_secure_entries_wizard.xml',
        'views/mail_message_views.xml',
        'wizard_test/accrued_orders.xml',
        ...
        'wizard_test/account_merge_wizard_views.xml',
    ],
    'demo': [
