...

{
    ...
    'data': [
        ...
        'wizard_test/change_production_qty_views.xml',
        'wizard_test/mrp_workcenter_block_view.xml',
        'wizard_test/stock_warn_insufficient_qty_views.xml',
        'wizard_test/mrp_production_backorder.xml',
        'wizard_test/mrp_consumption_warning_views.xml',
        'wizard_test/mrp_batch_produce.xml',
        'wizard_test/mrp_production_split.xml',
